...
function ucsf_preprocess_html(&$vars, $hook) {
...
function ucsf_preprocess_block(&$vars, $hook) {
...
function ucsf_preprocess_node(&$vars) {
 ...
 *
 */
function ucsf_menu_link(array $variables) {
  ...
  $element['#attributes']['class'][] = ucsf_id_safe($element['#title']);
